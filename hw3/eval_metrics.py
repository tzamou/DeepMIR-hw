...
def parse_opt():
    ...
    parser.add_argument('--dict_path', type=str,
                        help='the dictionary path', default=r'E:\python code\NTU_GICE\DLMIR\hw3\tutorial\basic_event_dictionary.pkl')
    parser.add_argument('--output_file_path', type=str,
                        help='the output file path.', default=r'E:\python code\NTU_GICE\DLMIR\hw3\tutorial\Pop1K7\midi_analyzed')
    # E:\python code\NTU_GICE\DLMIR\hw3\r13942067 hw3\Pop1K7\midi_analyzed
...
if __name__ == "__main__":
  ...
  test_pieces = sorted(glob(f'{opt.output_file_path}/*/*.mid'))
  ...
  if len(result_dict):
      ...
      df.to_csv(f'{opt.output_file_path}/pop1k7.csv', index=False, encoding='utf-8')