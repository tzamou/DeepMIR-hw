...
if __name__ == "__main__":
  ...
  parser.add_argument(
    ...
    ''', default='./sample_code/testing results/wav'
  )
  parser.add_argument(
    '-s', '--ssm_out_dir',
    required=False, type=str, help='output directory for computed SSMs', default='./sample_code/testing results/wav ssm result'
  )
  parser.add_argument(
    '-p', '--scplot_out_dir',
    required=False, type=str, help='output directory for computed fitness scape plots', default='./sample_code/testing results/wav fitness result'
  )
  parser.add_argument(
    '-j', '--num_workers',
    default=4, type=int, help='# of processes that will be spawned for SSM & scape plot computation'
  )
