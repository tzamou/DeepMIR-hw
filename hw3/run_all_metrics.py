...
if __name__ == "__main__":
  ...
  parser.add_argument(
    '-s', '--symbolic_dir',
    required=False, type=str, help='directory containing symbolic musical pieces.', default=f'./sample_code/testing results/GPT-12-50 t-0.3 topk-1/'
  )
  parser.add_argument(
    '-p', '--scplot_dir',
    required=False, type=str, help='directory containing fitness scape plots (of the exact SAME pieces as in ``symbolic_dir``).',
      default=r'E:\python code\NTU_GICE\DLMIR\hw3\tutorial\sample_code\testing results\wav fitness result'
  )
  parser.add_argument(
    '-o', '--out_csv',
    required=False, type=str, help='path to output file for results.',
      default=r'E:\python code\NTU_GICE\DLMIR\hw3\tutorial\sample_code\testing results\wav result2'
  )
  parser.add_argument(
    '--timescale_bounds',
